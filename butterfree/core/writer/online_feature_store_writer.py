...
class OnlineFeatureStoreWriter(Writer):
    ...
    Attributes:
        ...
        db_config: object with access configuration to storage. More information
            about the module in 'butterfree.core.db.configs'. Default: Cassandra
            DB.
    """

    def __init__(
        self, spark_client: SparkClient, db_config: AbstractWriteConfig = None
    ):
    ...
    def write(self, feature_set: FeatureSet, dataframe: DataFrame):
        """Loads the latest feature set data into the Online Feature Store.

        Args:
          feature_set: object processed with feature_set informations.
          dataframe: spark dataframe containing records from a feature set.
        """
    ...
    def validate(self, feature_set: FeatureSet, dataframe: DataFrame):
        """Calculate metrics to validate data into Online Feature Store.
