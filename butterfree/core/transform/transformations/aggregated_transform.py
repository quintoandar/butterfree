...
class AggregatedTransform(TransformComponent):
    ...
    def __init__(
        ...
        windows_agg: non_blank(List[str]),
    ...
    @property
    def windows_agg(self) -> List[str]:
        """Time ranges to be used in the windows."""
        return self._windows_agg

    @windows_agg.setter
    def windows_agg(self, windows: List[str]):
    ...
    def output_columns(self) -> List[str]:
        ...
        for aggregation in self._aggregations:
            for window in self._windows_agg:
