...
class AggregatedTransform(TransformComponent):
    ...
    __ALLOWED_AGGREGATIONS = {
        ...
        "array_contains": functions.array_contains,
        "sort_asc": functions.asc,
        ...
        "sort_desc": functions.desc,
        "explode_array": functions.desc,
        "greatest": functions.greatest,
        "max": functions.max,
        "min": functions.min,
        "regexp_extract": functions.regexp_extract,
        "sqrt": functions.sqrt,
        "sum": functions.sum,
