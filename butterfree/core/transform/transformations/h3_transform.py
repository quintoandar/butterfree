...
class H3HashTransform(TransformComponent):
    ...
    def with_stack(self):
        ...
        A new columns will be created stacking all the the resolution columns
        generated by H3. The name of this columns will be the name of the parent
        of H3Transform, for example, the name of the KeyFeature that has the H3
        as a transformation.
