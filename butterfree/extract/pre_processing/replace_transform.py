...
def replace(dataframe: DataFrame, column: str, replace_dict: Dict[str, str]) -> DataFrame:
    ...
    mapping = create_map([lit(value) for value in chain(*replace_dict.items())]) #type: ignore
