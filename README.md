...
```bash
    git clone git@github.com:quintoandar/butterfree-python.git
    cd butterfree-python
```
...
Library's content live under the [`quintoandar`](https://github.com/quintoandar/butterfree-python/tree/master/quintoandar)
module, where you'll find [it's public API exposed](https://github.com/quintoandar/butterfree-python/tree/master/quintoandar/__init__.py).
...
rely under the [test module](https://github.com/quintoandar/butterfree-python/tree/master/tests/unit)
and integration tests, under the [integration_test module](https://github.com/quintoandar/butterfree-python/tree/master/tests/integration).
...
care of. **Just make sure you update the lib version in [`setup.py`](https://github.com/quintoandar/butterfree-python/tree/master/setup.py)**.
...
`setup.py`](https://github.com/quintoandar/butterfree-python/tree/master/setup.py).
